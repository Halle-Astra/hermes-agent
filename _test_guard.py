...
# ── Heuristic tests ────────────────────────────────────────────
# Note: prev_was_tool gating is now at the CALLER level
# (conversation_loop checks _model_used_tools_this_turn),
# not inside _looks_like_premature_stop.  These tests only
# verify the heuristic itself.
...
SHOULD_CATCH = [
    ...
    ("short_cn_specific", "\u6211\u5c06\u6267\u884c\u8fd9\u4e2a\u547d\u4ee4\u6765\u68c0\u67e5\u72b6\u6001"),
]
...
print("\n=== CALLER-LEVEL GATE TEST ===")
print("  (In production, guard is SKIPPED entirely when model")
print("   has already called tools this turn. No heuristic needed.)")
